            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-gray-50/50">
                    <div>
                        ...
                        <p className="text-gray-500 text-sm mt-0.5">Set spending limits to save more money</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-8">
                    <form id="budget-form" onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <div className="bg-blue-50/30 p-8 rounded-2xl border border-blue-100">
                            <label className="block text-sm font-semibold text-gray-700 mb-2 text-center uppercase tracking-wide">
                                Monthly Limit
                            </label>
                            <div className="relative max-w-xs mx-auto">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-14 pr-4 py-4 text-3xl font-bold text-center bg-white border-2 border-transparent focus:border-blue-500 rounded-2xl text-gray-900 focus:ring-0 transition-all placeholder-gray-300 shadow-sm"
                                    placeholder="0.00"
                                    autoFocus
                                />
                            </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="block w-full pl-10 pr-4 py-3 bg-gray-50 focus:bg-white rounded-xl border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all appearance-none cursor-pointer"
                                >
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="block w-full pl-10 pr-4 py-3 bg-gray-50 focus:bg-white rounded-xl border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-blue-50/50 border border-blue-100 rounded-2xl p-5 flex gap-4">
                            ...
                            <div>
                                <h4 className="font-semibold text-blue-900 mb-1">Smart Alerts</h4>
