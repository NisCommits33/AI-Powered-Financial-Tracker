            ...
            <div className="min-h-screen bg-gray-50/50 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto space-y-8">
                    ...
                    <div className="bg-white rounded-3xl shadow-xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
                        {/* Status Messages */}
                        {isSuccess && (
                            <div className="p-4 bg-green-50 text-green-700 flex items-center gap-2 border-l-4 border-green-500">
                                <CheckCircle className="w-5 h-5" />
                                <span className="font-medium">Profile updated successfully!</span>
                            </div>
                        )}
                        {isError && (
                            <div className="p-4 bg-red-50 text-red-700 flex items-center gap-2 border-l-4 border-red-500">
