                ...
                <div className="mx-auto w-full max-w-md">
                    ...
                    <div className="lg:hidden mb-8">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div className="text-xl font-bold text-gray-900 dark:text-white">Finance Dashboard</div>
                        </div>
                    ...
                    <div className="space-y-6">
                                ...
                                <div className="p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1">
                                            <div className="font-medium text-red-900 dark:text-red-200">Authentication failed</div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-11 pr-4 py-3.5 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 bg-gray-50 dark:bg-gray-800 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200
                                            ${errors.email
                                                ...
                                                : isFocused.email
                                                    ? 'border-blue-300 dark:border-blue-700 focus:border-blue-400 focus:ring-blue-100 dark:focus:ring-blue-900/30'
                                                    : 'border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:border-blue-400 focus:ring-blue-100'
                                            }`}
                                    />
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                className={`w-full py-4 px-4 rounded-xl font-medium text-white transition-all duration-300 transform active:scale-[0.99]
                                    ${isLoading || !isDirty || !isValid
                                        ...
                                        : 'bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-lg hover:shadow-xl active:shadow-lg dark:shadow-blue-900/20'
                                    }`}
                            >
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-white dark:bg-gray-900 text-gray-500 dark:text-gray-400 transition-colors">Or sign in with</span>
                            </div>
                        </div>

                        {/* Social Login */}
                        <div className="grid grid-cols-2 gap-3">
                            <button className="flex items-center justify-center gap-3 py-3.5 px-4 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors group bg-white dark:bg-gray-800">
                        ...
                        <div className="pt-6 border-t border-gray-100 dark:border-gray-700">
                            <p className="text-center text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                <Link
                                    to="/register"
                                    className="font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors inline-flex items-center group"
                                >
                                    Get started free
